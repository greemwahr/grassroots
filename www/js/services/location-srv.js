...
*
*
* This script provides the script to get the users geolocation from the devices GPS.
*/

angular.module('grassroots').factory('locationSrv', [locationSrv]);

function locationSrv() {
	'use strict';
